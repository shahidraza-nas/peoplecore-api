...
const entity = snakeCase(Channel.name);

@ApiTags(entity)
@ApiBearerAuth()
@ApiErrorResponses()
@ApiExtraModels(Channel)
@Controller(entity)
export class ChannelController {
  ...
  async create(
    ...
    const { error, data } = await this.channelService.create({
      owner,
      action: 'create',
  ...
  async update(
    ...
    const { error, data } = await this.channelService.update({
      owner,
      action: 'update',
      id: +id,
  ...
  async countAll(
    ...
    const { error, count } = await this.channelService.getCount({
      owner,
      action: 'getCount',
      payload: { ...query },
    });
  ...
  @ResponseGetOne(Channel)
  async findOne(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Query() query: ApiQueryGetOne,
  ) {
    const { error, data } = await this.channelService.findOne({
      owner,
      action: 'findOne',
      payload: { ...query },
    });
  ...
  async findById(
    ...
    const { error, data } = await this.channelService.findById({
      owner,
      action: 'findById',
      id: +id,
      payload: { ...query },
  ...
  async delete(
    ...
    const { error, data } = await this.channelService.delete({
      owner,
      action: 'delete',
      id: +id,
      payload: { ...query },

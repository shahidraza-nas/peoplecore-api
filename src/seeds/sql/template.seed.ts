        ...
        <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
            ...
            <div style="background-color: #fef2f2; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #dc2626;">
              ...
              <p style="margin: 10px 0 0 0; font-size: 24px; color: #dc2626; font-weight: bold;">##daysRemaining## Days</p>
            </div>
            
            <div style="background-color: #f3f4f6; padding: 15px; border-radius: 6px; margin: 20px 0;">
              <p style="margin: 0;"><strong>Subscription Details:</strong></p>
              <p style="margin: 10px 0 0 0;">Plan: <strong>##planType##</strong></p>
              <p style="margin: 5px 0 0 0;">Expiry Date: <strong>##expiryDate##</strong></p>
            </div>
            ...
            <div style="margin: 30px 0; text-align: center;">
              <a href="##renewUrl##" style="display: inline-block; background-color: #2563eb; color: #ffffff; padding: 14px 40px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
